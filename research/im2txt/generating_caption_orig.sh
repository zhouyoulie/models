CHECKPOINT_PATH="/data/ylie_app/im2txt/model/train"
VOCAB_FILE="/data/ylie_app/im2txt/data/mscoco/word_counts.txt"
...
IMAGE_FILE="/data/ylie_app/im2txt/data/mscoco/raw-data/val2014/test_ylie_indian_tiger_in_the_wild.jpg"
