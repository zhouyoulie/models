...
"""Export wd logo detection model given existing training checkpoints.
...
tf.app.flags.DEFINE_string('checkpoint_dir', '/data/ylie_app/wd_object_detection/models/model/train_v3',
                           """Directory where to read training checkpoints.""")
tf.app.flags.DEFINE_string('output_dir', '/data/ylie_app/wd_object_detection/models/model/serve_model',
